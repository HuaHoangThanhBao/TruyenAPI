...
namespace CoreLibrary.Migrations
{
    public partial class createdatabase : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "noi_dung_truyen",
                columns: table => new
                {
                    NoiDungTruyenID = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TruyenID = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_noi_dung_truyen", x => x.NoiDungTruyenID);
                    table.ForeignKey(
                        name: "FK_noi_dung_truyen_truyen_TruyenID",
                        column: x => x.TruyenID,
                        principalTable: "truyen",
                        principalColumn: "TruyenID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_noi_dung_truyen_TruyenID",
